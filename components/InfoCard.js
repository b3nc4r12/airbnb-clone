...
const InfoCard = ({ img, location, title, description, star, price, total }) => {
    return (
        <div className="flex items-center py-7 px-4 border-b cursor-pointer shadow-md hover:opacity-80 hover:shadow-lg scale-102 transition transform duration-200 ease-out bg-white rounded-2xl">
            ...
            <div className="flex flex-col flex-grow pl-5">
                ...
                <div className="flex items-endr justify-between py-5">
